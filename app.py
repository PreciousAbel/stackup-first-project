...
options_education_level = [
    "Junior high school", "Elementary school", "High school", 
    "Unknown", "Above high school", "Writing & reading", 
    "Illiterate"
]

options_services_year = [
    "Unknown", "2-5yrs", "Above 10yr", "5-10yrs", "1-2yr", "Below 1yr"
]

options_acc_area = [
    "Other", "Office areas", "Residential areas", "Church areas",
    "Industrial areas", "School areas", "Recreational areas", 
    "Outside rural areas", "Hospital areas", "Market areas",
    "Rural village areas", "Unknown", "Rural village areas", 
    "Office areas", "Recreational areas"
]
    ...
    with st.form("road_traffic_severity_form"):
        ...
        if submit:
            input_array = np.array(
                [
                    collision, Age_band, Sex, Education, service_vehicle, 
...
st.text(
    """This data set is collected from Addis Ababa Sub-city police departments for master's 
    research work. The data set has been prepared from manual records of road traffic 
    accidents of the year 2017-20. 
    All the sensitive information has been excluded during data encoding and finally it has 
    32 features and 12316 instances of the accident.
    Then it is preprocessed and for identification of major causes of the accident by 
    analyzing it using different machine learning classification algorithms.
    """
)
...
st.text(
    ...
    The task is to classify this variable based on the other 31 features step-by-step by
    going through each day's task. 
